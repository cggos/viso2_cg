...
public:
    ...
    // computes features from left/right images and pushes them back to a ring buffer,
...
private:
    ...
    inline void
    computeDescriptor(const uint8_t *I_du, const uint8_t *I_dv, const int32_t &bpl,
                      const int32_t &u, const int32_t &v, uint8_t *desc_addr);

    inline void computeSmallDescriptor(const uint8_t *I_du, const uint8_t *I_dv, const int32_t &bpl, const int32_t &u,
    ...
    inline void
    findMatch(int32_t *m1, const int32_t &i1, int32_t *m2,
              ...
              bool flow, bool use_prior, double u_ = -1, double v_ = -1);
    ...
    void matching(
            ...
            int32_t method, bool use_prior, Matrix *Tr_delta = 0);
    ...
    inline float mean(const uint8_t *I, const int32_t &bpl,
