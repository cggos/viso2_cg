    ...
    protected:
        ...
        void imageCallback(
            ...
            if (!visual_odometer_) {
                ...
                // read calibration info from camera info message to fill remaining odometer parameters
                ...
                ROS_INFO_STREAM("Initialized libviso2 mono odometry with the following parameters:" << std::endl <<
