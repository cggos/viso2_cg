...
namespace viso2_ros {
    ...
    public:
        ...
        void printTF_XYZQuat(const tf::Transform &tf, std::string str) {
...
//            tf.getBasis().getRPY(roll, pitch, yaw);
    ...
    protected:
        ...
        void integrateAndPublish(const tf::Transform &delta_transform, const ros::Time &timestamp) {
            ...
            if (tf_listener_.canTransform(base_link_frame_id_, sensor_frame_id_, timestamp, &error_msg)) {
                ...
                tf_listener_.lookupTransform(base_link_frame_id_, sensor_frame_id_, timestamp, base_to_sensor);
    ...
    private:
        ...
        tf::Transform integrated_pose_; // the current integrated camera pose

        ros::Time last_update_time_;    // timestamp of the last update
